...
_LV_OBJ_STYLE_SET_GET_DECLARE(CLIP_CORNER, clip_corner, Boolean, _int, scalar)
...
_LV_OBJ_STYLE_SET_GET_DECLARE(BORDER_POST, border_post, Boolean, _int, scalar)
...
_LV_OBJ_STYLE_SET_GET_DECLARE(PATTERN_REPEAT, pattern_repeat, Boolean, _int, scalar)
...
_LV_OBJ_STYLE_SET_GET_DECLARE(LINE_ROUNDED, line_rounded, Boolean, _int, scalar)
