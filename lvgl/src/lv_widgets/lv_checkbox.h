 ...
 */
static inline void lv_checkbox_set_checked(lv_obj_t * cb, Boolean checked)
{
 ...
 */
static inline Boolean lv_checkbox_is_checked(const lv_obj_t * cb)
{
 ...
 */
static inline Boolean lv_checkbox_is_inactive(const lv_obj_t * cb)
{
