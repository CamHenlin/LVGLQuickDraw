...
static Boolean button_is_hidden(lv_btnmatrix_ctrl_t ctrl_bits);
static Boolean button_is_repeat_disabled(lv_btnmatrix_ctrl_t ctrl_bits);
static Boolean button_is_inactive(lv_btnmatrix_ctrl_t ctrl_bits);
static Boolean button_is_click_trig(lv_btnmatrix_ctrl_t ctrl_bits);
static Boolean button_is_tgl_enabled(lv_btnmatrix_ctrl_t ctrl_bits);
static Boolean button_get_tgl_state(lv_btnmatrix_ctrl_t ctrl_bits);
...
static Boolean maps_are_identical(const char ** map1, const char ** map2);
...
static lv_design_res_t lv_btnmatrix_design(lv_obj_t * btnm, const lv_area_t * clip_area, lv_design_mode_t mode)
{
    ...
    /*Draw the object*/
        ...
        Boolean chk_inited = false;
        Boolean disabled_inited = false;
        ...
        for(btn_i = 0; btn_i < ext->btn_cnt; btn_i++, txt_i++) {
            ...
            Boolean tgl_state = button_get_tgl_state(ext->ctrl_bits[btn_i]);
...
static void make_one_button_toggled(lv_obj_t * btnm, uint16_t btn_idx)
{
    ...
    Boolean was_toggled = lv_btnmatrix_get_btn_ctrl(btnm, btn_idx, LV_BTNMATRIX_CTRL_CHECK_STATE);
