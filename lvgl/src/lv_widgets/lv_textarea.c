...
static Boolean char_is_accepted(lv_obj_t * ta, uint32_t c);
...
void lv_textarea_add_char(lv_obj_t * ta, uint32_t c)
{
    ...
    Boolean edge_flash_en = lv_textarea_get_edge_flash(ta);
...
static lv_res_t lv_textarea_signal(lv_obj_t * ta, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_CLEANUP) {
        ...
        Boolean * editable = (Boolean *)param;
        *editable       = true;
    }
