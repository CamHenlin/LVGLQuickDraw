 ...
 */
void lv_table_set_cell_crop(lv_obj_t * table, uint16_t row, uint16_t col, Boolean crop)
{
    LV_ASSERT_OBJ(table, LV_OBJX_NAME);
 ...
 */
void lv_table_set_cell_merge_right(lv_obj_t * table, uint16_t row, uint16_t col, Boolean en)
{
    LV_ASSERT_OBJ(table, LV_OBJX_NAME);
 ...
 */
Boolean lv_table_get_cell_merge_right(lv_obj_t * table, uint16_t row, uint16_t col)
{
    LV_ASSERT_OBJ(table, LV_OBJX_NAME);
