 ...
 */
void lv_textarea_set_cursor_hidden(lv_obj_t * ta, Boolean hide);
 ...
 */
void lv_textarea_set_cursor_click_pos(lv_obj_t * ta, Boolean en);
 ...
 */
void lv_textarea_set_pwd_mode(lv_obj_t * ta, Boolean en);
 ...
 */
void lv_textarea_set_one_line(lv_obj_t * ta, Boolean en);
 ...
 */
static inline void lv_textarea_set_scroll_propagation(lv_obj_t * ta, Boolean en)
{
 ...
 */
static inline void lv_textarea_set_edge_flash(lv_obj_t * ta, Boolean en)
{
 ...
 */
void lv_textarea_set_text_sel(lv_obj_t * ta, Boolean en);
 ...
 */
Boolean lv_textarea_get_cursor_hidden(const lv_obj_t * ta);
 ...
 */
Boolean lv_textarea_get_cursor_click_pos(lv_obj_t * ta);
 ...
 */
Boolean lv_textarea_get_pwd_mode(const lv_obj_t * ta);
 ...
 */
Boolean lv_textarea_get_one_line(const lv_obj_t * ta);
 ...
 */
static inline Boolean lv_textarea_get_scroll_propagation(lv_obj_t * ta)
{
 ...
 * @return true or false
 */
static inline Boolean lv_textarea_get_edge_flash(lv_obj_t * ta)
{
 ...
 */
Boolean lv_textarea_text_is_selected(const lv_obj_t * ta);
 ...
 */
Boolean lv_textarea_get_text_sel_en(lv_obj_t * ta);
