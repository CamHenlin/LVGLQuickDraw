...
static Boolean lv_list_is_list_btn(lv_obj_t * list_btn);
static Boolean lv_list_is_list_img(lv_obj_t * list_btn);
static Boolean lv_list_is_list_label(lv_obj_t * list_btn);
 ...
 */
static Boolean lv_list_is_list_label(lv_obj_t * list_label)
{
    lv_obj_type_t type;
 ...
 */
static Boolean lv_list_is_list_img(lv_obj_t * list_img)
{
    lv_obj_type_t type;
